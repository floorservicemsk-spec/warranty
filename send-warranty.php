<?php
// Настройки почты
$to_email = "sundoze87@gmail.com"; // ЗАМЕНИТЕ НА ВАШУ ПОЧТУ!
$subject = "Новая активация гарантии с сайта";
...
$telegram_bot_token = "8442800039:AAFJMmlfQEMwnxeMLvT3xJHJnAB-wMVG604"; // Замените на токен вашего бота
$telegram_chat_id = "@sundoze"; // Замените на chat_id или @username
...
$headers .= "From: Форма гарантии сайта <noreply@yourdomain.com>" . "\r\n";
